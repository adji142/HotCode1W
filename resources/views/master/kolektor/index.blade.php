...
@section('breadcrumb')
	...
	<li class="breadcrumb-item"><a href="{{ route('kolektor.index') }}">Kolektor</a></li>
@endsection
				...
				<div class="x_content">
					...
					<div style="cursor: pointer; margin-top: 10px;" class="hidden">
						<p>
							...
							&nbsp;&nbsp;|&nbsp;&nbsp;
							<a class="toggle-vis" data-column="1"><i id="eye1" class="fa fa-eye"></i> Nama Karyawan</a>
							&nbsp;&nbsp;|&nbsp;&nbsp;
							<a class="toggle-vis" data-column="2"><i id="eye2" class="fa fa-eye"></i> Kode Collector</a>
						</p>
					</div>
				</div>
			</div>
	...
	$(document).ready(function() {
		table = $('#table1').DataTable({
			...
			columns		: [
			    ...
			    { "data" : "kodecollector", "className" : 'menufilter numberfilter' },
			]
		});
