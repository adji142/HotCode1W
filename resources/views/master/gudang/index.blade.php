				...
				<div class="x_content">
					...
					<div style="cursor: pointer; margin-top: 10px;" class="hidden">
						<p>
							...
							<a class="toggle-vis" data-column="0"><i id="eye0" class="fa fa-eye"></i> Kode Subcabang</a>
							&nbsp;&nbsp;|&nbsp;&nbsp;
							<a class="toggle-vis" data-column="1"><i id="eye1" class="fa fa-eye"></i> Nama Cabang</a>
							&nbsp;&nbsp;|&nbsp;&nbsp;
							<a class="toggle-vis" data-column="2"><i id="eye2" class="fa fa-eye"></i> Nama Subcabang</a>
							&nbsp;&nbsp;|&nbsp;&nbsp;
							<a class="toggle-vis" data-column="3"><i id="eye3" class="fa fa-eye"></i> Init Subcabang</a>
							&nbsp;&nbsp;|&nbsp;&nbsp;
							<a class="toggle-vis" data-column="4"><i id="eye4" class="fa fa-eye"></i> Aktif</a>
						</p>
					</div>
				</div>
			</div>
...
<script type="text/javascript">
	...
	$(document).ready(function() {
		table = $('#table1').DataTable({
			...
			columns		: [
			    { "data" : 'kodesubcabang', "className" : 'menufilter textfilter' },
	            { "data" : 'namacabang', "className" : 'menufilter textfilter' },
	            { "data" : 'namasubcabang', "className" : 'menufilter textfilter' },
	            { "data" : 'initsubcabang', "className" : 'menufilter textfilter' },
