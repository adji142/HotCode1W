				...
				<div class="x_content">
					...
					<div style="cursor: pointer; margin-top: 10px;" class="hidden">
						<p>
							...
							<a class="toggle-vis" data-column="0"><i id="eye0" class="fa fa-eye"></i> Nama Perusahaan</a>
							&nbsp;&nbsp;|&nbsp;&nbsp;
							<a class="toggle-vis" data-column="1"><i id="eye1" class="fa fa-eye"></i> Kode Cabang</a>
							&nbsp;&nbsp;|&nbsp;&nbsp;
							<a class="toggle-vis" data-column="2"><i id="eye2" class="fa fa-eye"></i> Nama Cabang</a>
							&nbsp;&nbsp;|&nbsp;&nbsp;
	...
	$(document).ready(function() {
		table = $('#table1').DataTable({
			...
			columns		: [
			    ...
			    { "data" : "kodecabang", "className" : 'menufilter textfilter' },
