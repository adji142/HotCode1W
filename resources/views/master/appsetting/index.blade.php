...
@section('breadcrumb')
	...
	<li class="breadcrumb-item"><a href="{{ route('appsetting.index') }}">Appsetting</a></li>
@endsection
				...
				<div class="x_content">
					...
					<div style="cursor: pointer; margin-top: 10px;" class="hidden">
						<p>
							...
							<a class="toggle-vis" data-column="0"><i id="eye0" class="fa fa-eye"></i> Subcabang</a>
							&nbsp;&nbsp;|&nbsp;&nbsp;
							<a class="toggle-vis" data-column="1"><i id="eye1" class="fa fa-eye"></i> Key ID</a>
							&nbsp;&nbsp;|&nbsp;&nbsp;
							<a class="toggle-vis" data-column="2"><i id="eye2" class="fa fa-eye"></i> Keterangan</a>
							&nbsp;&nbsp;|&nbsp;&nbsp;
							<a class="toggle-vis" data-column="3"><i id="eye3" class="fa fa-eye"></i> Value</a>
						</p>
					</div>
				</div>
			</div>
	...
	$(document).ready(function() {
		table = $('#table1').DataTable({
			...
			columns		: [
			    ...
			    { "data" : "keyid", "className" : 'menufilter textfilter' },
			    { "data" : "keterangan", "className" : 'menufilter textfilter' },
			    { "data" : "value", "className" : 'menufilter textfilter' },
			]
		});
