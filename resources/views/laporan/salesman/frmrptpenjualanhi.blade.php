...
<li class="breadcrumb-item active">Penjualan Hubungan Istimewa</li>
@endsection
...
<div class="">
    <div class="row">
        <div class="x_panel">
            <div class="x_title">
                <h2>Penjualan Hubungan Istimewa</h2>
            ...
            <div class="x_content">
                <form id="formTambah" class="form-horizontal form-label-left" method="POST" action="{{route('rptpenjualanhi.report')}}" target="_blank">
                    ...
                    <div class="col-md-12 col-xs-12">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-7 col-sm-7 col-xs-12" style="padding:1%;">
                                <input type="radio" id="harga1" name="harga" value="hbeli" class="iCheck" /> Hrg Beli
                                <input type="radio" id="harga2" name="harga" value="hppa" class="iCheck" /> Hrg Rata-Rata
                            </div>
                        </div>
                    </div>
                    <div class="col-md-12">
