...
@section('main_container')
	...
	<table class="table display nowrap table-bordered" id="table_report" width="100%" cellspacing="0">
		<thead>
			<tr>
				<th rowspan="2" class="text-center">TOKO</th>
				<th rowspan="2" class="text-center">WILID</th>
				...
				<th colspan="4" class="text-center">PENCAPAIAN PENJUALAN NETTO</th>
			...
			<tr>
				...
				<th class="text-center">PERIODE TERTINGGI</th>
