<htmlpageheader name="MyHeader1">
    <div style="padding-top: 1pt;">
        <table width="100%" cellspacing="0" cellpadding="2">
            <tr>
                <td><h1 style="margin-bottom: 0;">PROFORMA INVOICE</h1></td>
...
<table width="100%" cellspacing="0" cellpadding="2">
    ...
    <tr>
        <td rowspan="5" colspan="2"><barcode code="{{Carbon\Carbon::parse($nota->tglproforma)->format('Ym').$nota->nonota}}" type="C39" height="2" size="0.5"/></td>
    </tr>
    <tr>
