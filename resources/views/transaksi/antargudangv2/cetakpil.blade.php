...
<table width="100%" cellspacing="0" cellpadding="2" style="border-top: 1px solid #000; border-bottom: 1px solid #000;">
    <thead>
        <tr>
            ...
            <th width="8%" style="border-bottom: 1px solid #000;">Qty Rq</th>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td style="text-align: center;">{{ $row->qtyrqag }}</td>
...
<table width="100%" cellspacing="0" cellpadding="2">
    ...
    <tr>
        <td style="text-align: center;">{{ $ag->stockpengirim }}</td>
        <td style="text-align: center;">{{ $ag->checkerpengirim1 }}</td>
        <td style="text-align: center;">{{ $ag->checkerpengirim2 }}</td>
        <td></td>
    </tr>
</table>
