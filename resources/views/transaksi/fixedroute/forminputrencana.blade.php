...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item active">Form Input Luar Rencana</li>
@endsection
        ...
        <div class="x_content">
          ...
          <div class="form-group">
            ...
            <div class="col-md-12" align="right">
              @can('fixedroute.tambahrecordkunjunganluarrencana')
    ...
    $(document).ready(function(){
      ...
      if (count > 0) {
        ...
        //cek apakah record data > 4 kunjungan pada bulan yang sama;
         $.ajax({
            type: 'POST',
            url : '{{route("fixedroute.tambahrecordkunjunganluarrencana")}}',
            data: {
            ...
            success: function(data){
              ...
              //jika tidak input berdasarkan toko 
              else{
                swal('Yes!', 'Data Berhasil ditambahkan' ,'success');
