                    ...
                    @endcan
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <input type="text" id="c1" name="c1" class="form-control" value="{{$subcabanguser}}" readonly tabindex="-1">
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4 col-sm-4 col-xs-12">
                                        <input type="text" id="tglmpr" name="tglmpr" class="tgl form-control" value="{{date('d-m-Y')}}" data-inputmask="'mask': 'd-m-y'" required onblur="chkTgl(this.value)">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4 col-sm-4 col-xs-6">
                                        <div class="input-group">
                                            <span class="input-group-addon"><i class="fa fa-search"></i></span>
                                            <input type="text" id="expedisi" class="form-control" placeholder="Expedisi" value="{{isset($expedisi)? $expedisi->namaexpedisi:'PT SURYA ANUGRAH ABADI'}}" autocomplete="off" required>
                                        </div>
                                    </div>
                                    <div class="col-lg-2 col-md-2 col-sm-3 col-xs-4">
                                            <input type="text" id="kodeexpedisi" readonly="readonly" class="form-control" value="SAS">
                                            <input type="hidden" id="expedisiid" name="expedisiid" value="{{isset($expedisi)? $expedisi->id:'388'}}">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="control-label col-md-2 col-sm-2 col-xs-12" for="karyawanexpedisi">Staff Pengambil Barang <span class="required">*</span></label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <div class="input-group">
                                            <span class="input-group-addon"><i class="fa fa-search"></i></span>
                                            <input type="text" id="karyawanexpedisi" class="form-control" placeholder="Staff Pengambil Barang" value="{{isset($karyawanexpedisi)? $karyawanexpedisi->namakaryawanexpedisi:''}}" autocomplete="off" required>
                                            <input type="hidden" id="karyawanexpedisiid" name="karyawanidexpedisi" value="{{isset($karyawanexpedisi)? $karyawanexpedisi->id:''}}">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <div class="input-group">
                                            ...
                                            <input type="hidden" id="karyawanpenjualanid" name="karyawanidpenjualan" value="{{isset($karyawanpenjualan)? $karyawanpenjualan->id:''}}">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <div class="input-group">
                                            <span class="input-group-addon"><i class="fa fa-search"></i></span>
                                            <input type="text" id="karyawanstock" class="form-control" placeholder="Staff Stok" value="{{isset($karyawanstock)? $karyawanstock->namakaryawanstock:''}}" autocomplete="off" readonly tabindex="-1">
                                            <input type="hidden" id="karyawanstockid" name="karyawanidstock" value="{{isset($karyawanstock)? $karyawanstock->id:''}}">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                @endcan
                                @can('returpenjualan.tambah.detail')
            ...
            <div class="modal-content">
                ...
                <form id="formDetail" class="form-horizontal" method="post">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-default" data-dismiss="modal">Batal</button>
                        <button type="submit" class="btn btn-primary svdet">Tambah</button>
                    </div>
                </form>
            </div>
        </div>
...
@push('scripts')
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function(){
            ...
            //     pilih_expedisi();
            // });
            // $('#modalExpedisi table.tablepilih tbody').on('dblclick', 'tr', function(){
            //     pilih_expedisi();
            // });
            ...
            //     pilih_npjd();
            // });
            // $('#modalNPJD table.tablepilih tbody').on('dblclick', 'tr', function(){
            //     pilih_npjd();
            // });
            ...
            //     pilih_kategoriretur();
            // });
            // $('#modalKategoriRetur table.tablepilih tbody').on('dblclick', 'tr', function(){
            //     pilih_kategoriretur();
            // });
            ...
            $('#formRetur').submit(function(e){
                ...
                if ($('#karyawanexpedisiid').val()=='') {
                    ...
                    swal("Ups!", "Staff Pengambil Barang belum dipilih.", "error");
                    return false;
                }
                ...
                $.ajax({
                    ...
                    success: function(data){
                        ...
                        if(data.success){
                            ...
                            $('.svdet').removeAttr('disabled');
                            $('#hrgsatuanbrutto').removeAttr('readonly tabindex="-1"');
                            $('#disc1').removeAttr('readonly tabindex="-1"');
                            $('#disc2').removeAttr('readonly tabindex="-1"');
                            $('#ppn').removeAttr('readonly tabindex="-1"');
                        }else{
        ...
        //     $.ajax({
        //         type: 'GET',
        //         url: '{{route("lookup.getsubcabang",null)}}/' + query,
        //         success: function(data){
        ...
        //                     x +=        '<input type="hidden" class="karyawansalesmanid" value="'+ toko[i].karyawanidsalesman +'">';
        ...
        //     $.ajax({
        //         type: 'GET',
        //         url: '{{route("lookup.getexpedisi",[null,null])}}/' + recowner + '/' + query,
        //         success: function(data){
        ...
        //         $('#karyawan'+tipestaff+'id').val($('#tbodyStaff').find('tr.selected td .id_sup').val());
        ...
        function chkTgl(tgl){
            ...
            if(tgl > now){
                ...
                swal('Ups!', "tanggal MPR melebihi tanggal server",'error'); 
            }else{
