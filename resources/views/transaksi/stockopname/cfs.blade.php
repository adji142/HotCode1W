...
<table width="100%" cellspacing="0" cellpadding="2" style="border-top: 1px solid #000; border-bottom: 1px solid #000;">
    ...
    <tbody>
        ...
        <tr>
            <td style="text-align: center;height: 60;">{{$brg->stockid}}.</td>
            <td>{{$brg->namabarang}}</td>
            <td style="text-align: center;">{{$brg->area1}}</td>
            <td style="text-align: center;">{{$brg->area2}}</td>
            <td style="text-align: center;">{{$brg->area3}}</td>
            <td style="text-align: center;">{{$brg->qtybaik}}</td>
            <td style="text-align: center;">{{$brg->qtyrusak}}</td>
        </tr>
        @endforeach
    </tbody>
</table>
